function posePriorFeat = computePosePriorsChair(dataStruct, poseFeat)
...
% matrix)
poseFeat = predsToRotationChair(poseFeat');
poseFeat = poseFeat{1};
posePriorFeat = neighborMapsKpsScoreChair(poseFeat, dataStruct.bbox, trainData);
